...
Model sam trenirao algoritmom grupnog gradijentnog spusta (batch gradient descent) sa 5000 iteracija. Tacnost na trening i dev skupu su 0.95486,0.9567, dok model treniran na istim podacima pomocu biblioteke sklearn na 5000 iteracija i sa penality = None i solver = liblinear, ima 0.97822 i 0.95486 na trening i dev skupu.
Model koji sam trenirao sa l2 regulacijom